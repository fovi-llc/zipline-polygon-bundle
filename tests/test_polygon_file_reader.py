...
class TestPolygonFileReader(unittest.TestCase):
    ...
    def test_convert_timestamp(self):
        ...
        self.assertEqual(
            convert_timestamp("0000000000000000"), pd.Timestamp("1970-01-01 00:00:00")
        )
        self.assertEqual(
            convert_timestamp("00000000000001"), pd.Timestamp("1970-01-01 00:00:01")
        )
        self.assertEqual(
            convert_timestamp("1000000001"), pd.Timestamp("2001-09-09 01:46:41")
        )
        self.assertEqual(
            convert_timestamp("5000000000"), pd.Timestamp("2128-06-11 08:53:20")
        )
        # 10_000_000_000 is the threshold for milliseconds
        self.assertEqual(
            convert_timestamp("10000000001"), pd.Timestamp("1970-04-26 17:46:40.001000")
        )
        # 100_000_000_000_000 is the threshold for nanoseconds
        self.assertEqual(
            convert_timestamp("100000000000001"),
            pd.Timestamp("1970-01-02 03:46:40.000000001"),
        )
